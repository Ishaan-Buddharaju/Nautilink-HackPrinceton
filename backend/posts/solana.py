...
async def load_program() -> Program:
    ...
    dummy_keypair = Keypair.generate()
...
async def build_create_crate_transaction(
    ...
    try:
        ...
        authority = PublicKey(authority_pubkey)
        
        # Generate new keypair for crate record
        crate_keypair = Keypair.generate()
        crate_pubkey = crate_keypair.public_key
        ...
        keypair_secret = crate_keypair.secret_key
